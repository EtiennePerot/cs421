...
def run():
	...
	if author is None:
		author = Author.create(name="Catherine Bellaire")
	publisher = publisherByName("Chrysalis Music")
	if publisher is None:
		publisher = Publisher.create(name="Chrysalis Music")
	Audio.create(
		title="Single",
		date="1983-07-11",
		format=Audio.format_vinyl,
	...
	if author is None:
		author = Author.create(name="Janelle Monae")
	publisher = publisherByName("Carlin America, Inc.")
	if publisher is None:
		publisher = Publisher.create(name="Carlin America, Inc.")
	Audio.create(
		title="We are young",
		date="1991-12-31",
		format=Audio.format_cd,
	...
	if author is None:
		author = Author.create(name="Bob Caule")
	publisher = publisherByName("All Boys Music")
	if publisher is None:
		publisher = Publisher.create(name="All Boys Music")
	Audio.create(
		title="It's time",
		date="1998-01-17",
		format=Audio.format_cd,
	...
	if author is None:
		author = Author.create(name="Trisha MacDonald")
	publisher = publisherByName("Third Side Music")
	if publisher is None:
		publisher = Publisher.create(name="Third Side Music")
	Audio.create(
	...
	if author is None:
		author = Author.create(name="Walid Alfred")
	publisher = publisherByName("Third Side Music")
	if publisher is None:
		publisher = Publisher.create(name="Third Side Music")
	Audio.create(
