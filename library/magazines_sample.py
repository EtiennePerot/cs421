...
def run():
	...
	if author is None:
		author = Author.create(name="George Treant")
	author_list.append(author)
	author = authorByName("Lucas Benner")
	if author is None:
		author = Author.create(name="Lucas Benner")
	author_list.append(author)
	publisher_list=[]
	publisher = publisherByName("Guideposts / Ideals")
	if publisher is None:
		publisher = Publisher.create(name="Guideposts / Ideals")
	...
	if author is None:
		author = Author.create(name="Tyra Holmes")
	author_list.append(author)
	author = authorByName("Eleonore Lafee")
	if author is None:
		author = Author.create(name="Eleonore Lafee")
	author_list.append(author)
	author = authorByName("Mathilde Laurence")
	if author is None:
		author = Author.create(name="Mathilde Laurence")
	author_list.append(author)
	publisher_list=[]
	publisher = publisherByName("Guideposts / Ideals")
	if publisher is None:
	...
	if author is None:
		author = Author.create(name="Jimmy Watsons")
	author_list.append(author)
	publisher_list=[]
	publisher = publisherByName("Hodder Education")
	if publisher is None:
		publisher = Publisher.create(name="Hodder Education")
	publisher_list.append(publisher)
	Magazine.create(
		title="Tech: 101",
		date="2012-01-18",
	...
	if author is None:
		author = Author.create(name="James Williams")
	author_list.append(author)
	publisher_list=[]
	publisher = publisherByName("Brookings Institution Press")
	if publisher is None:
		publisher = Publisher.create(name="Brookings Institution Press")
	publisher_list.append(publisher)
	Magazine.create(
		title="The Globe",
		date="2012-02-27",
	...
	if author is None:
		author = Author.create(name="Mike Simons")
	author_list.append(author)
	publisher_list=[]
	publisher = publisherByName("Qcards")
	if publisher is None:
		publisher = Publisher.create(name="Qcards")
	publisher_list.append(publisher)
	Magazine.create(
		title="Are you game",
		date="2012-02-27",
