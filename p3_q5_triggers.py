...
""")
sqlQuery("""
    INSERT INTO people (pnid, email, address, password, salt, name) VALUES (1, 'yvanblanc@googlemail.com', '336 Park Avenue, Montreal, QC', '8749bb8f1c227f31f8c5e2b61838a471', '734501cc1b22d85193d8a72ec4cefb3e', 'Yvan Blanc')
""")

sqlQuery("""
    INSERT INTO members (pnid, standing, balance, expiration) VALUES (1, 'good', 0, '2013-2-28')
""")
...
sqlQuery("""
    INSERT INTO members (pnid, standing, balance, expiration) VALUES (2, 'bad', 18, '2012-01-15')
""")
...
sqlQuery("""
    INSERT INTO items (iid, title, date) VALUES (1, 'Hero Conquest', '2003-12-18')
""")

sqlQuery("""
    INSERT INTO instances (instid, iid) VALUES (1, 1)
""")
...
sqlQuery("""
    CREATE TRIGGER on_rental AFTER INSERT ON reserved_by FOR EACH ROW begin IF EXISTS(SELECT * from members where pnid = new.pnid and standing='bad') THEN UPDATE `Error: You cannot borrow/reserve items with a bad standing` SET x=0;END IF; End
""")
