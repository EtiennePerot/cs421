...
INSERT INTO items(iid, title, date) VALUES(5, 'The Binding of Matheus', '2004-03-28')

INSERT INTO books(iid, isbn, pages, toc) VALUES(5, 8999, 150, '<toc><chapter num="1" name="The Binding of Matheus" page="1"><chapter num="1.1" name="The Revelation" page="2"/><chapter num="1.2" name="Escape to the Abyss" page="20"/><chapter num="1.3" name="The Iron Gate" page="36"/><chapter num="1.4" name="Keeper of the key" page="42"/><chapter num="1.5" name="Unfriendly Encounter" page="57"/></chapter><chapter num="2" name="The Sword of Nexus" page="68"><chapter num="2.1" name="The Order of Kalimdor" page="69"/><chapter num="2.2" name="The Conquest of Isaroth" page="86"/><chapter num="2.3" name="The Nexus" page="100"/></chapter><chapter num="3" name="The Apocalypse" page="108"><chapter num="3.1" name="The Rift " page="109"/><chapter num="3.2" name="Mirror World" page="119"/><chapter num="3.3" name="The Final Encounter" page="132"/><chapter num="3.4" name="To Kalimdor" page="145"/></chapter></toc>')

INSERT INTO items(iid, title, date) VALUES(6, 'Cooking for dummies', '2005-02-01')

INSERT INTO books(iid, isbn, pages, toc) VALUES(6, 8999, 17, '<toc><chapter num="1" name="Entrees" page="1"><chapter num="1.1" name="Grilled chicken" page="2"/><chapter num="1.2" name="Braised duck" page="3"/><chapter num="1.3" name="Chicken noodles" page="4"/><chapter num="1.4" name="Sushi" page="5"/><chapter num="1.5" name="Fried fish" page="6"/></chapter><chapter num="2" name="Main dishes" page="7"><chapter num="2.1" name="Pork chop" page="8"/><chapter num="2.2" name="5 cheese pizza " page="9"/><chapter num="2.3" name="Pineapple salad" page="10"/></chapter><chapter num="3" name="Desserts" page="11"><chapter num="3.1" name="Soufflé" page="12"/><chapter num="3.2" name="Yogurt cake" page="13"/><chapter num="3.3" name="Fruit salad" page="14"/><chapter num="3.4" name="Baklava" page="15"/></chapter></toc>')

INSERT INTO items(iid, title, date) VALUES(7, 'Python 101', '2010-12-08')

INSERT INTO books(iid, isbn, pages, toc) VALUES(7, 3923, 46, '<toc><chapter num="1" page="1"><chapter num="1.1" name="Introduction" page="2"/><chapter num="1.2" name="Main features" page="5"/><chapter num="1.3" name="Interactive Python" page="10"/><chapter num="1.4" name="Data types" page="13"/><chapter num="1.5" name="Simple statements" page="16"/><chapter num="1.6" name="Control structures" page="20"/><chapter num="1.7" name="Organization " page="24"/><chapter num="1.7" name="Main libraries" page="30"/><chapter num="1.8" name="Serialization" page="34"/><chapter num="1.9" name="Unit testing" page="36"/><chapter num="1.10" name="Conclusion" page="42"/></chapter></toc>')

INSERT INTO items(iid, title, date) VALUES(8, 'Programming Pearls', '1999-10-07')

INSERT INTO books(iid, isbn, pages, toc) VALUES(8, 0201657880, 239, '<toc><chapter num = "1" name="Cracking the Oyster" page = "3"><chapter num = "1.1" name="A Friendly Conversation" page="3"/><chapter num = "1.2" name="Precise Problem Statement" page= "4"/><chapter num = "1.3" name = "Program Design" page = "4"/><chapter num = "1.4" name = "Implementation Sketch" page = "5"/><chapter num = "1.5" name = "Principles" page = "6"/><chapter num = "1.6" name = "Problems" page = "7"/></chapter><chapter num = "2" name= "Aha! Algorithms" page= "11"><chapter num = "2.1" name= "Three Problems" page = "11"/><chapter num = "2.2" name = "Ubiquitous Binary Search" page = "12"/><chapter num = "2.3" name = "The Power of Primitives" page = "13"/><chapter num = "2.4" name = "Getting It Together: Sorting" page = "15"/><chapter num = "2.7" name = "Further Reading" page ="18"/><chapter num = "2.8" name = "Implementing an Anagram Program" page = "18"/></chapter><chapter num = "3" name = "Data Structures Programs" page="21"/><chapter num = "4" name = "Writing Correct Programs" page = "33"/></toc>')

INSERT INTO items(iid, title, date) VALUES(9, 'The Adventure of Chess', '1959-01-01')

INSERT INTO books(iid, isbn, pages, toc) VALUES(9, 048620510, 296, '<toc><chapter num = "1" name="Historic Kaleidoscope" page = "3"><chapter num = "1.1" name= "The Indian Ancestry of Chess: Chaturanga. Chess with Dice. Four-handed Chess" page = "3"/><chapter num = "1.2" name = "Chess in the Far East" page="9"/><chapter num="1.3" name="Persias Leading Role: The Story of Wajurgmitr. Chess in the Byzantine Empire" page="14"/><chapter num = "1.4" name = "Chess Comes of Age Under Moslem Rule" page = "22"/><chapter num ="1.5" name = "Chess Invades Western Europe: The Hostility of the Church. Chess in Medieval Romance. Reformation of Chess in the Fifteenth Century. Capablancas Suggestion for Further Reform. F.V. Morleys My One Contribution to Chess" page = "30" /><chapter num = "1.6" name = "Chess in Russia: Mongol Chess. Chess and the Tsars. The Soviets Introduce Chess in Schools. Russian Chess Masters Dominating Chess" page = "41"/></chapter><chapter num = "2" name = "The Literature and the Early Masters of Reformed Chess" page = "47"><chapter num = "2.1" name = "Lucena, Damiano, and Ruy Lopez" page = "47"/><chapter num = "2.2" name="Boi, Salvio, Greco, and Stamma" page="49"/><chapter num = "2.3" name = "Andre Philidor" page="52"/><chapter num ="2.4" name="Blindfold Play" page="59"/></chapter></toc>')

INSERT INTO items(iid, title, date) VALUES(10, 'Artificial Intelligence: A Modern Approach', '2009-12-11')

INSERT INTO books(iid, isbn, pages, toc) VALUES(10, 0136042597, 1132, '<toc><chapter num = "1" name= "Introduction" page = "1"><chapter num = "1.1" name = "What is AI?" page = "1"/><chapter num = "1.2" name = "The Foundations of Artificial Intelligence" page = "5"/><chapter num = "1.3" name = "The History of Artificial Intelligence" page = "16"/><chapter num = "1.4" name = "The State of the Art" page = "28"/><chapter num = "1.5" name = "Summary, Bibliography, and Historical Notes, Exercises" page = "29"/></chapter><chapter num = "2" name = "Intelligent Agents" page = "34"><chapter num = "2.1" name = "Agents and Environments" page = "34"/><chapter num = "2.2" name = "Good Behavior: The Concept of Rationality" page = "36"/><chapter num = "2.3" name = "The Nature of Environments" page = "40"/><chapter num = "2.4" name = "The Structure of Agents" page = "46"/><chapter num = "2.5" name = "Summary, Bibliographical and Historical Notes, Exercises" page = "59"/></chapter></toc>')
